Factory.define(:xbox_console_user) do |f|    
  data = HashExtras.underscorize_and_symbolize_all_keys!(Hash.from_xml(File.open(File.join(RAILS_ROOT, "spec/files/xml/xbox_live/jpgnotgif.xml"), "r") { |file| file.read     }))
